              ...
              return (
                <div key={v.id} data-testid={`vehicle-${v.id}`} className="solid-card overflow-hidden">
                  <div className="relative h-32 bg-stone-200">
                    <img src={VEHICLE_IMG[v.type]} alt={cat.name} loading="lazy" className="w-full h-full object-cover" />
                  ...
                  <div className="p-5 space-y-3">
                    ...
                    <div>
                      <div className="flex items-center justify-between text-xs mb-1.5">
                        ...
                        <span className="font-semibold text-stone-900">{v.condition}%</span>
                      </div>
                      <Progress value={v.condition} className="h-1.5" />
                    </div>
                    {broken && (
              ...
              <div key={key} className="solid-card overflow-hidden hover:-translate-y-[2px] transition-all">
                ...
                <div className="p-5">
                  ...
                  <div className="flex items-center gap-1.5 text-xs text-stone-500 mt-1">
                    ...
                    {cat.fuel_per_day_active} L/jour actif
                  </div>
                  {bonuses.length > 0 && (
